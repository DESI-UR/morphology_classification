#!/usr/bin/env python3
"""
Generate 152x152 Legacy Surveys cutouts,
...
def viewer_cutout_url(ra, dec, size_pix, pixscale, bands=BANDS, layer=LAYER, sga=SGA):
...
def main(targets_csv, outdir, bands=BANDS, size=CUTOUT_SIZE_PIX, layer=LAYER,
    ...
    for _, row in df.iterrows():
        ...
        size_pix = int(size)
        pix_scale = float(row["bin_id"])*PIX_SCALE
